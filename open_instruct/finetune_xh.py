...
from open_instruct.utils_granite import debug_chat_template_tokenization, stop_debugging
...
def main(args: FlatArguments):
    ...
    if args.dataset_name is not None:
        ...
        stop_debugging(accelerator,"STOP AFTER GET_DATASETS")
    else:
        data_files = {}
        dataset_args = {}
